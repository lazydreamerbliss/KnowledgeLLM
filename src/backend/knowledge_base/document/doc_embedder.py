...
class DocEmbedder:
    ...
    @log_time_cost(
        start_log='Embedding text',
        end_log='Text embedded',
        LOGGER=LOGGER
    )
    ...
    @log_time_cost(
        start_log='Predicting text similarity',
        end_log='Text similarity predicted',
        LOGGER=LOGGER
    )
    ...
    @log_time_cost(
        start_log='Predicting text similarity in batch',
        end_log='Text similarity batch predicted',
        LOGGER=LOGGER
    )
